...
public class EmailNotificationServiceCliente {
    ...
    public void notifyClienteCreated(final ClienteModel cliente) {
    ...
    public void notifyClienteCreated(final ClienteModel cliente, final String password) {
        final String template = loadTemplate("cliente-created.html");
        final String body =
                renderTemplate(
                        template,
    ...
    public void notifyClienteUpdated(final ClienteModel cliente) {
        final String template = loadTemplate("cliente-updated.html"); // Asegúrate de tener este archivo
